...
agent = Agent(
        ...
        override_system_message=override_system_message,  # Thay thế hệ thống tin nhắn
    )
...
async def main():
    ...
    result = await evaluator.evaluate_with_playwright(task_id, agent_result=test_result, browser=browser)
